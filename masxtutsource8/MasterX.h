...
// Helper typedef's so you dont gotta use evil M$ stuff
...
// enumerated graphic constants

enum { INTROG = 0, GAMEOVERG };

// prototype for graphic handler
class graphicHandler
{
	MasterXHWND* mxhwnd;
public:
	MasterGraphic graphic[GRSIZE];
