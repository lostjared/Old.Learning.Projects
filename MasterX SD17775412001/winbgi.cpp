// winbgi written by some guy I dont know
// sorry couldnt find his name anywere in the source
// was sent to me from a friend
// I expanded it to work using masterX
...
static HDC hdc[4];
static MasterXHWND mxhwnd; // masterX hwnd object
...
void initgraph(int* device, int* mode, char const* /*pathtodriver*/)
{
	...
	if(mxhwnd.CreateMasterX("MasterXBGI",1024,768,COLOR_DEFAULT,WndProc,GetModuleHandle(NULL),NULL,NULL))
	{
	}
	else {
		exit(0); // fatal error
