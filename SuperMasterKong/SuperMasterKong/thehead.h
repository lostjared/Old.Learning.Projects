...
#define MASTERXSDK
#include"masterlibrary4.h" // masterlibrary4 -=) wheew that took a while
#include<fstream>
#include"resource.h"
...
public:
	...
	virtual void load()
	{
		...
		mxhwnd.LoadSound(&sounds[2],MAKEINTRESOURCE(IDR_WAVE3));
		mxhwnd.LoadSound(&sounds[3],MAKEINTRESOURCE(IDR_WAVE4));
	}
