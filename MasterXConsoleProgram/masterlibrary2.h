/*
	...
	MasterLibrary 2 written by Jared Bruni
	www.LostSideDead.com
	
	  herers over 8,000 lines of code in C and C++ for Visual C++ 6.0
...
void FAST MasterText::printtextrect(char* strtext, int x, int y, int w, int h)
{
	...
	DrawText(dc,strtext,strlen(strtext),&rt,DT_EDITCONTROL | DT_WORDWRAP);
